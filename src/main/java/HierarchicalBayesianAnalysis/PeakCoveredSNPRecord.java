...
public class PeakCoveredSNPRecord {
    private String snpCallingFile, peakCallingFile;
    private Logger logger;

    public PeakCoveredSNPRecord(String snpCallingFile, String peakCallingFile) {
    ...
    public void getPeakCoveredSNP() {
        PeakCoveredSNP pcs = new PeakCoveredSNP(this.snpCallingFile, this.peakCallingFile, this.logger);
